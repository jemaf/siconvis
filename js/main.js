...
var draw = function(element, data) {
	...
	d3Data = data.records.map(function(element) {
		var newItems = element.items.map(function(innerElement) {
			...
			return {key: element.uf, x: innerElement.date, y: +innerElement.value};
		});
	...
	d3PercentageData = data.records.map(function(element) {
		var newItems = element.items.map(function(innerElement) {
			...
			return {key: element.uf, x: innerElement.date, y: innerElement.value / innerElement.yearValue * 100};
		});
    ...
    .on("mouseover", function(d, i) {
      ...
      tooltip.html( "<p>" + "Laerte" + "</p>" ).style("visibility", "visible");
  	})
